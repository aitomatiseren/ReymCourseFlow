...
const createCourseSchema = (t: any) => z.object({
  title: z.string().min(1, t('courses:addDialog.titleRequired')),
...
type CourseFormData = z.infer<ReturnType<typeof createCourseSchema>>;
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="text-center py-4 border-b">
              <h2 className="text-2xl font-bold text-gray-900">
                {watchedTitle || t('courses:addDialog.newCourse')}
              </h2>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('courses:addDialog.courseTitle')} *</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('courses:addDialog.description')}</FormLabel>
                  <FormControl>
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('courses:addDialog.sessionsRequired')}</FormLabel>
                    <FormControl>
                      <Input 
                        {...field} 
                        type="number" 
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center space-x-2">
                      ...
                      <FormLabel className="text-sm font-medium">
                        ...
                        {t('courses:addDialog.code95Course')}
                      </FormLabel>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-center space-x-2">
                      ...
                      <FormLabel className="text-sm font-medium">
                        {t('courses:addDialog.requiresApproval')}
                      </FormLabel>
                    </FormItem>
                  )}
                />
              ...
              {watchedChecklistItems.map((item, index) => (
                <div key={item.id} className="flex items-center space-x-2 p-3 border rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label className="text-sm">{t('courses:addDialog.required')}</label>
                  </div>
                  <Button
                    type="button"
                    variant="ghost"
